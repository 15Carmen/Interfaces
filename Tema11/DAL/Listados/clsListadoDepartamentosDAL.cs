...
namespace DAL.Listados
{
    ...
    {
        public static async Task<List<clsDepartamento>> listadoCompletoDepartamentosDAL()
        {
        ...
        public static async Task<clsDepartamento> obtenerDepartamentoPorIdDAL(int id)
        {
            string miCadenaUrl = clsConexion.conexionApi();
